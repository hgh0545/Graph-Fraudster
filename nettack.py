...
class Nettack(BaseAttack):
    ...
    def __init__(self, model, nnodes=None, nclass=None):

        super(Nettack, self).__init__(model, nnodes)
    ...
    def attack(self, features, adj, labels, target_node, n_perturbations, direct=True, n_influencers= 0, ll_cutoff=0.004, verbose=True, attack_structure=True, attack_features=False):
        """
